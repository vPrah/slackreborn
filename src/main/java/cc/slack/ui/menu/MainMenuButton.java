...
public class MainMenuButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            RenderUtil.drawRoundedRectBorder(this.xPosition - 1, this.yPosition + MainMenu.animY - 1, this.xPosition + width + 1, this.yPosition + this.height + MainMenu.animY + 1, 5,  new Color(10, 10, 10, 180 ).getRGB(), 2);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            RenderUtil.drawRoundedRectBorder(this.xPosition, this.yPosition + MainMenu.animY, this.xPosition + width, this.yPosition + this.height+ MainMenu.animY, 5,  new Color(255, 255, 255, 220 ).getRGB(), 1);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
