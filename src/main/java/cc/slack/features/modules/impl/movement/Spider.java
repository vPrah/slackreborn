            ...
            if (mc.getPlayer().isCollidedHorizontally) {
                switch (vulcanTicks) {
                    ...
                    case 3:
                        ...
                        ((C03PacketPlayer) packet).x -= MathHelper.sin((float) Math.toRadians(mc.getPlayer().rotationYaw)) * 0.1;
                        ((C03PacketPlayer) packet).z += MathHelper.cos((float) Math.toRadians(mc.getPlayer().rotationYaw)) * 0.1;
                }
                p.setPacket(packet);
            }
        }
