...
public class BlockOverlay extends Module {
    ...
    public void onRender (RenderEvent event) {
        ...
        if (mc.getMinecraft().objectMouseOver != null && mc.getMinecraft().objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            Render2DUtil.glColor(new Color(r, g, b, alphaValue.getValue()).getRGB());
            ...
            Render3DUtil.drawSelectionBoundingBox(new AxisAlignedBB(x + minX, y + minY, z + minZ, x + block.getBlockBoundsMaxX(), y + block.getBlockBoundsMaxY(), z + block.getBlockBoundsMaxZ()));
            Render2DUtil.glColor(new Color(0, 0, 0).getRGB());
